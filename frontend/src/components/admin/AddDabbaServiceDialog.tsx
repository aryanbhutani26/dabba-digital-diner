...
interface AddDabbaServiceDialogProps {
  onSuccess: () => void;
}

export const AddDabbaServiceDialog = ({ onSuccess }: AddDabbaServiceDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error.message || "Failed to create dabba service",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Add New Dabba Service</DialogTitle>
          <DialogDescription>
            Create a new dabba/tiffin service package for customers.
          </DialogDescription>
        </DialogHeader>
